...
class PersonalAccountPage(BasePage):
    ...
    def move_to_the_personal_account_by_authorized_user(self) -> bool:
    ...
    def move_to_the_personal_account_by_unauthorized_user(self) -> str:
        self.driver.get(UrlLib.BASE_PAGE_URL)
        self.click_on_the_element(BasePagePaths.personal_button)

        return self.wait_element_to_be_visible(LoginPagePaths.login_header).text

    def user_order_is_displayed_in_the_history_tab_when_the_order_placed(self, home_page_obj) -> dict:
        home_page_order_number = home_page_obj.place_an_order_by_authorized_user()
