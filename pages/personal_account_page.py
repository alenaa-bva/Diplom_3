...
class PersonalAccountPage(BasePage):
    ...
    def move_to_the_personal_account_by_authorized_user(self, driver, login_page_obj) -> bool:
    ...
    def user_order_is_displayed_in_the_history_tab_when_the_order_placed(self, driver, home_page_obj) -> dict:
        ...
        history_tab_order_number = self.wait_element_to_be_visible(driver, PersonalAccountPagePaths.last_order_number).text
