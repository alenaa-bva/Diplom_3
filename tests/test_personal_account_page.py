...
class TestPersonalAccountPage:
    ...
    def test_move_to_the_personal_account_by_authorized_user(self, driver):
        ...
        personal_page_profile_tab_text = personal_page_obj.move_to_the_personal_account_by_authorized_user()
    ...
    def test_move_to_the_personal_account_by_unauthorized_user(self, driver):
        personal_page_obj = PersonalAccountPage(driver)
        login_page_header_text = personal_page_obj.move_to_the_personal_account_by_unauthorized_user()
    ...
    def test_user_order_is_displayed_in_the_history_tab_when_the_order_placed(self, driver):
        ...
        personal_page_obj = PersonalAccountPage(driver)
        order_number = personal_page_obj.user_order_is_displayed_in_the_history_tab_when_the_order_placed(home_page_obj)
    ...
    def test_logout(self, driver):
        personal_page_obj = PersonalAccountPage(driver)
        login_page_header_text = personal_page_obj.logout()
